...
if __name__ == '__main__':
    ...
    script, cook_book_path, header_file_path, out_file_path = argv
    ...
    menu_to_print= select_menu(menus,correct_date_obj)
    ...
    print "Does the output file exist? %r" % exists(out_file_path)
    ...
    header_open= open(header_file_path)
    # print cook_book_open.read()
    header_txt=header_open.read()
    # print cook_book_text

    out_file = open(out_file_path, 'w')
    out_file.write(header_txt)
    out_file.write(menu_to_print)
    ...
    #   of code does and how.
        ...
        # On line 17 you have sunday_number = (next_sunday.day / 7).
        # This will take the date of next Sunday, divide by 7 and round to the
        #nearest whole number, which indicates which Sunday of the month it is.
        # Your array on line 7, and your variable on line 23 convert the integer
        # an ordinal.
